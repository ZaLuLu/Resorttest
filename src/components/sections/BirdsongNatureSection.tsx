      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
        ...
        <CinematicReveal className="text-center space-y-3 max-w-2xl mx-auto">
          <div className="inline-flex items-center gap-2 rounded-full border border-[#D5C7B2] bg-[#FAF6EF] px-4 py-1.5 text-xs font-bold text-[#A3733E] shadow-sm">
            <Feather className="w-4 h-4 text-[#A3733E]" />
            <span className="tracking-wide uppercase">Acoustic Nature Experience</span>
          </div>

          <h2 className="text-3xl sm:text-5xl md:text-6xl font-bold text-[#132422] font-display leading-tight heading-balance">
