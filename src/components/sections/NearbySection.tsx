      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-10">
        ...
        <CinematicReveal className="text-center max-w-2xl mx-auto space-y-2">
          <div className="inline-flex items-center gap-1.5 rounded-full border border-[#D5C7B2] bg-[#FAF6EF] px-3.5 py-1 text-xs font-bold text-[#A3733E] shadow-sm">
            ...
            <span>Kushalnagar Strategic Base</span>
          </div>
          ...
          <p className="text-xs sm:text-sm text-[#344E4A] font-medium leading-relaxed">
        ...
        <div className="text-center pt-2">
          <Link
            to="/nearby"
            className="px-6 py-3 rounded-full text-xs font-bold text-white bg-[#132422] hover:bg-[#1E3633] shadow-md inline-flex items-center gap-2 transition-all hover:scale-105 active:scale-95 cursor-pointer"
          >
