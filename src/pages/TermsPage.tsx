  ...
  return (
    <div className="pt-24 pb-28 bg-[#FAF7F2] text-[#18110D] select-none">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 pt-8 space-y-6">
        <div className="rounded-3xl bg-white p-6 sm:p-10 border border-[#E4D9C8] shadow-sm space-y-6 text-sm text-[#2C413E] font-normal leading-relaxed prose-pretty">
          <div className="space-y-2">
            <h3 className="font-display text-lg font-bold text-[#132422]">1. Reservations & Confirmation</h3>
            <p>
          ...
          <div className="space-y-2">
            <h3 className="font-display text-lg font-bold text-[#132422]">2. Check-In & Check-Out Timings</h3>
            <p>
          ...
          <div className="space-y-2">
            <h3 className="font-display text-lg font-bold text-[#132422]">3. Cancellation & Rescheduling Policy</h3>
            <p>
          ...
          <div className="space-y-2">
            <h3 className="font-display text-lg font-bold text-[#132422]">4. Swimming Pool & Outdoor Amenities</h3>
            <p>
          ...
          <div className="space-y-2">
            <h3 className="font-display text-lg font-bold text-[#132422]">5. Contact & Inquiries</h3>
            <p>
              For booking assistance, rate queries, or buyout details, contact our concierge directly at{' '}
              <a href={`mailto:${resortData.contact.email}`} className="text-[#137586] font-bold underline">
                {resortData.contact.email}
              </a>{' '}
              or via WhatsApp at{' '}
              <a href={`https://wa.me/${resortData.contact.whatsapp}`} className="text-[#137586] font-bold underline">
