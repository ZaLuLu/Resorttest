      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 pt-8 space-y-6">
        <div className="rounded-3xl bg-white p-6 sm:p-10 border border-[#E4D9C8] shadow-sm space-y-6 text-sm text-[#2C413E] font-normal leading-relaxed prose-pretty">
          <div className="space-y-2">
            <h3 className="font-display text-lg font-bold text-[#132422]">1. Information We Collect</h3>
            <p>
          ...
          <div className="space-y-2">
            <h3 className="font-display text-lg font-bold text-[#132422]">2. How We Use Your Information</h3>
            <p>
          ...
          <div className="space-y-2">
            <h3 className="font-display text-lg font-bold text-[#132422]">3. Contact Us</h3>
            <p>
              If you have any questions regarding this policy or wish to update your details, please contact us directly at{' '}
              <a href={`mailto:${resortData.contact.reservationEmail}`} className="text-[#137586] font-bold underline">
